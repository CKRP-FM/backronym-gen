    ...
    <div className="aboutModal" onClick={props.onClose}>
      ...
      <div className="aboutContent" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="aboutMain">
          <p>
            The definition of ‘backronym’ (bakre,nim) is ‘an acronym deliberately formed from a phrase whose initial
            letters spell out a particular word or words, either to create a memorable name or as a fanciful explanation
            of a word’s origin. ie “Biodiversity Serving Our Nation, or BISON”’.
          </p>
